...
/*Returns null if the value is not found in the dictionary.*/ 
/*If more than one key exists that matches the given value, it returns the 1st one found.*/
...
/*A fail-fast system is designed to immediately report at its interface any failure 
or condition that is likely to lead to failure.*/
public Iterator<K> keys();

/*Returns an Iterator of the values in the dictionary.*/
/*The order of the values must match the order of the keys.*/
/*he iterator must be fail-fast.*/ 
